...
import {productFeedIsConfiguredOnce, productFeedEnabled, productFeedIsConfigured} from '../.storybook/mock/product-feed';
...
import {googleAdsNotChosen, googleAdsAccountConnectedOnce} from "../.storybook/mock/google-ads";
...
SmartShoppingCampaigns.args = {
  beforeMount(this: any) {
    ...
    this.$store.state.googleAds = Object.assign({}, googleAdsAccountConnectedOnce);
  },
};
