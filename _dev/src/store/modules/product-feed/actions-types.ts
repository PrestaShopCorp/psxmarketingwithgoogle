...
enum ActionsTypes {
  // ATTENTION : is it normal that these two following have same name ?
  GET_VALIDATION_LIST = 'GET_VALIDATION_LIST',
  GET_SUMMARY_VALIDATION = 'GET_VALIDATION_LIST',
  ...
  SUSPEND_SYNCHRONISATION = 'SUSPEND_SYNCHRONISATION',
