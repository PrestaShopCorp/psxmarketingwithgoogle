...
enum MutationsTypes {
    ...
    SET_REPORTING_PRODUCTS_PARTITIONS_PERFORMANCES_SECTION_ERROR = 'SET_REPORTING_PRODUCTS_PARTITIONS_PERFORMANCES_SECTION_ERROR',
