...
enum GettersTypes {
  ...
  GET_ENHANCED_CONVERSIONS_NEVER_ENABLED = 'GET_ENHANCED_CONVERSIONS_NEVER_ENABLED',
  GET_ENHANCED_CONVERSIONS_TOGGABLE = 'GET_ENHANCED_CONVERSIONS_TOGGABLE',
  ...
  GET_ACCOUNT_HAS_AT_LEAST_ONE_CAMPAIGN = 'GET_ACCOUNT_HAS_AT_LEAST_ONE_CAMPAIGN',
