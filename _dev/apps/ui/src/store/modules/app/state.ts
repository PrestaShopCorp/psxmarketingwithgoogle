...
export const state: State = {
  ...
  cloudsyncVersionNeeded: process.env.VITE_MIN_VERSION_NEEDED_CLOUD_SYNC || '',
  psxMktgWithGoogleModuleVersionNeeded: process.env.VITE_MIN_VERSION_NEEDED_MKTG_GOOGLE || '',
