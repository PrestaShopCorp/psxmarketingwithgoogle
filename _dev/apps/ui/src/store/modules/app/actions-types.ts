...
enum ActionsTypes {
  ...
  GET_BANNER_SUCCESS_LOCAL_STORAGE_MONETIZATION = 'GET_BANNER_SUCCESS_LOCAL_STORAGE_MONETIZATION',
  GET_BANNER_INFO_LOCAL_STORAGE_MONETIZATION = 'GET_BANNER_INFO_LOCAL_STORAGE_MONETIZATION'
}
