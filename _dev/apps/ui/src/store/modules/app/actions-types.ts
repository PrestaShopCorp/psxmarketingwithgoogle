...
enum ActionsTypes {
  ...
  SET_BANNER_SUCCESS_LOCAL_STORAGE_MONETIZATION = 'SET_BANNER_SUCCESS_LOCAL_STORAGE_MONETIZATION',
  SET_BANNER_INFO_LOCAL_STORAGE_MONETIZATION = 'SET_BANNER_INFO_LOCAL_STORAGE_MONETIZATION'
}
