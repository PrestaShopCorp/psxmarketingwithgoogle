        ...
        $translations[$locale] = [
            ...
            'productFeedSettings' => [
                ...
                'attributeMapping' => [
                    ...
                    'sellRefurbished' => $this->module->l('Do you sell refurbished products ?', 'PsxMktgWithGoogleTranslations'),
                    'sellApparel' => $this->module->l('Do you sell apparel and accessories ?', 'PsxMktgWithGoogleTranslations'),
            ...
            'smartShoppingCampaignCreation' => [
                ...
                'inputBudgetInvalidFeedback' => $this->module->l('placholder invalid feedback', 'PsxMktgWithGoogleTranslations'),
            ...
            'keymetrics' => [
                ...
                'impressionsTooltip' => $this->module->l('How often your ad is shown. An impression is counted each time your ad is shown on a search result page or other site on the Google Network.', 'PsxMktgWithGoogleTranslations'),
                ...
                'conversion' => $this->module->l('Conversion', 'PsxMktgWithGoogleTranslations'),
                'conversionTooltip' => $this->module->l('An action that\'s counted when someone interacts with your ad or free product listing (for example, clicks a text ad or views a video ad) and then takes an action that you’ve defined as valuable to your business, such as an online purchase or a call to your business from a mobile phone.', 'PsxMktgWithGoogleTranslations'),
                'costPerClick' => $this->module->l('Avg cost / click', 'PsxMktgWithGoogleTranslations'),
                'costPerClickTooltip' => $this->module->l('The average amount that you\'ve been charged for a click on your ad. Average cost-per-click (avg. CPC) is calculated by dividing the total cost of your clicks by the total number of clicks.', 'PsxMktgWithGoogleTranslations'),
              ...
              'campaignsPerformanceTable' => [
                ...
                'labelCampaign' => $this->module->l('Campaign', 'PsxMktgWithGoogleTranslations'),
                'labelBudget' => $this->module->l('Budget', 'PsxMktgWithGoogleTranslations'),
                'labelStatus' => $this->module->l('Status', 'PsxMktgWithGoogleTranslations'),
                'labelImpression' => $this->module->l('Impression', 'PsxMktgWithGoogleTranslations'),
                'labelClicks' => $this->module->l('Clicks', 'PsxMktgWithGoogleTranslations'),
                'labelAdSpend' => $this->module->l('Ad spend', 'PsxMktgWithGoogleTranslations'),
                'labelConversion' => $this->module->l('Conversion', 'PsxMktgWithGoogleTranslations'),
                'labelSales' => $this->module->l('Sales', 'PsxMktgWithGoogleTranslations'),
                'tooltipStatus' => $this->module->l('Placeholder tooltip status', 'PsxMktgWithGoogleTranslations'),
            ],
              'productsPerformanceTable' => [
                ...
                'labelID' => $this->module->l('ID', 'PsxMktgWithGoogleTranslations'),
                'labelProduct' => $this->module->l('Product', 'PsxMktgWithGoogleTranslations'),
                'labelClick' => $this->module->l('Click', 'PsxMktgWithGoogleTranslations'),
                'labelCosts' => $this->module->l('Costs', 'PsxMktgWithGoogleTranslations'),
                'labelAverageCPC' => $this->module->l('Average CPC', 'PsxMktgWithGoogleTranslations'),
                'labelConversions' => $this->module->l('Conversions', 'PsxMktgWithGoogleTranslations'),
                'labelConversionsRate' => $this->module->l('Conversions rate', 'PsxMktgWithGoogleTranslations'),
                'labelSales' => $this->module->l('Sales', 'PsxMktgWithGoogleTranslations'),
            ],
            'productFeedPage' => [
