    ...
    public function getTranslations()
    {
        ...
        $translations[$locale] = [
            ...
            'productFeedCard' => [
                ...
                'intro' => $this->module->l('Submit your product data directly to your Merchant Center and keep them always up to date for free listing and ads.', 'PsGoogleShoppingTranslations'),
            ...
            'productFeedPage' => [
                ...
                'productStatus' => [
                    ...
                    'productsInGoogleCatalog' => $this->module->l('Number of products: {0}', 'PsGoogleShoppingTranslations'),
