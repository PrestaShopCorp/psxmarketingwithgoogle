...
class Config
{
    ...
    const MERCHANT_GMC_ID = 'MERCHANT_GMC_ID';
    const MERCHANT_GMC_FEED_COUNTRY = 'MERCHANT_GMC_FEED_COUNTRY';
    const MERCHANT_GMC_FEED_LANGUAGE = 'MERCHANT_GMC_FEED_LANGUAGE';
}
